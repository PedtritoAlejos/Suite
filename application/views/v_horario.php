...
<script type="text/javascript" src="<?php echo base_url() ?>js/funci_horario.js"></script>
    ...
    if (parseInt(document.getElementById("hora_e").value)<24&&parseInt(document.getElementById("hora_e").value>=0))
        ...
        <center>
            <div style="text-align:  center; width: 100%;">
                    <h3 style="background:#32cd32; color: white ; border: 2px solid #cccccc;
 ...
 <?php
        foreach ($horari as $fila2):
            ...
            <tr>
                ...
                <td id="anho<?= $fila2->id_horario ?>"><?= $fila2->anho  ?></td>
