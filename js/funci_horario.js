...
<form name='edit' id='edit' method='post' action='http://localhost/suite/index.php/c_horario/multi_hora'>" +
                ...
                "Editar": function () {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            setTimeout(function () {
                                window.location.href = "http://localhost/suite/index.php/c_horario";
                            }, 2000);
        ...
        $("<div class='delete_modal'>¡Estás seguro que deseas eliminar al horario ?</div>").dialog({
            ...
            buttons: {
                "Eliminar": function () {
                    $.ajax({
                        type: 'POST',
                        url: 'http://localhost/suite/index.php/c_horario/delete_hora',
                        async: true,
                        data: {id: id},
                        complete: function () {
