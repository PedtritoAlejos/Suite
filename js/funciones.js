...
<form name='edit' id='edit' method='post' action='http://localhost/suite/index.php/c_cliente/multi_user'>"+
            ...
            "<label>Fecha final</label><input style='color: black;' type='date' name='fecha_final_e' class='nombre' value="+fecha_final+" id='nombre' /><br/>"+
                        ...
                        $.ajax({
                            ...
                            success:function (data) {
                                   $('.edit_modal').dialog("close");
                                    ...
                                    setTimeout(function() {
                                        window.location.href = "http://localhost/suite/index.php/c_cliente";
                                    }, 2000);
        ...
        $("<div class='delete_modal'>¡Estás seguro que deseas eliminar al cliente " + nombre + "?</div>").dialog({
            ...
            buttons:{
                ...
                "Eliminar":function () {
                    $.ajax({
                        type:'POST',
                        url:'http://localhost/suite/index.php/c_cliente/delete_user',
                        async: true,
                        data: { id : id },
                        complete:function () {
