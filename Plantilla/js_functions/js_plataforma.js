                ...
                return "<div class='btn-group'> \n\
                        ...
                        data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>\n\
                            ...
                            <ul class='dropdown-menu'>\n\
                                <li><a href='#' onclick='modificar_plataforma("+row.Codigo+",\x22"+row.Nombre+"\x22 ,\x22"+row.Cpu+"\x22,\x22"+row.Ram+"\x22,\x22"+row.So+"\
...
function modificar_plataforma(code,nombre,cpu,ram,so,proposito,servicio,cliente){//metodo que pregunta en una ventana modal si se quiere modificar
